export const palettes = Object.freeze({
   ...
   halfWhites: [
      {red: 166, green: 144, blue: 144, name: 'Liquitex: Alizarin Crimson Hue Permanent (Half-White)'},
      {red: 159, green: 155, blue: 152, name: 'Liquitex: Raw Umber (Half-White)'},
      {red: 238, green: 232, blue: 144, name: 'Liquitex: Yellow Light Hansa (Half-White)'},
      {red: 228, green: 143, blue: 141, name: 'Liquitex: Cadmium Red Medium (Half-White)'},
      {red: 230, green: 225, blue: 212, name: 'Liquitex: Parchment (Half-White)'},
      {red: 136, green: 200, blue: 197, name: 'Liquitex: Bright Aqua Green (Half-White)'},
      {red: 133, green: 184, blue: 218, name: 'Liquitex: Brilliant Blue (Half-White)'},
      {red: 175, green: 161, blue: 195, name: 'Liquitex: Brilliant Purple (Half-White)'},
      {red: 198, green: 223, blue: 152, name: 'Liquitex: Brilliant Yellow Green (Half-White)'},
      {red: 198, green: 180, blue: 150, name: 'Liquitex: Bronze Yellow (Half-White)'},
      {red: 181, green: 153, blue: 145, name: 'Liquitex: Burnt Sienna (Half-White)'},
      {red: 158, green: 150, blue: 147, name: 'Liquitex: Burnt Umber (Half-White)'},
      {red: 235, green: 177, blue: 128, name: 'Liquitex: Cadmium Orange (Half-White)'},
      {red: 243, green: 187, blue: 128, name: 'Liquitex: Cadmium Orange Hue (Half-White)'},
      {red: 190, green: 136, blue: 139, name: 'Liquitex: Cadmium Red Deep Hue (Half-White)'},
      {red: 230, green: 158, blue: 146, name: 'Liquitex: Cadmium Red Light (Half-White)'},
      {red: 235, green: 157, blue: 147, name: 'Liquitex: Cadmium Red Light Hue (Half-White)'},
      {red: 219, green: 144, blue: 144, name: 'Liquitex: Cadmium Red Medium Hue (Half-White)'},
      {red: 245, green: 203, blue: 128, name: 'Liquitex: Cadmium Yellow Deep Hue (Half-White)'},
      {red: 250, green: 220, blue: 128, name: 'Liquitex: Cadmium Yellow Medium (Half-White)'},
      {red: 242, green: 211, blue: 128, name: 'Liquitex: Cadmium Yellow Medium Hue (Half-White)'},
      {red: 242, green: 227, blue: 128, name: 'Liquitex: Cadmium Yellow Light (Half-White)'},
      {red: 249, green: 234, blue: 128, name: 'Liquitex: Cadmium Yellow Light Hue (Half-White)'},
      {red: 142, green: 171, blue: 207, name: 'Liquitex: Cerulean Blue Hue (Half-White)'},
      {red: 146, green: 174, blue: 209, name: 'Liquitex: Cerulean Blue (Half-White)'},
      {red: 165, green: 180, blue: 155, name: 'Liquitex: Chromium Oxide Green (Half-White)'},
      {red: 140, green: 145, blue: 197, name: 'Liquitex: Cobalt Blue Hue (Half-White)'},
      {red: 143, green: 153, blue: 193, name: 'Liquitex: Cobalt Blue (Half-White)'},
      {red: 143, green: 173, blue: 171, name: 'Liquitex: Cobalt Green (Half-White)'},
      {red: 134, green: 199, blue: 210, name: 'Liquitex: Cobalt Teal (Half-White)'},
      {red: 134, green: 174, blue: 177, name: 'Liquitex: Cobalt Turquiose (Half-White)'},
      {red: 181, green: 139, blue: 147, name: 'Liquitex: Deep Magenta (Half-White)'},
      {red: 152, green: 142, blue: 143, name: 'Liquitex: Deep Violet (Half-White)'},
      {red: 147, green: 143, blue: 143, name: 'Liquitex: Dioxazine Purple (Half-White)'},
      {red: 136, green: 185, blue: 159, name: 'Liquitex: Emerald Green (Half-White)'},
      {red: 143, green: 153, blue: 147, name: 'Liquitex: Deep Green Permanent (Half-White)'},
      {red: 166, green: 168, blue: 146, name: 'Liquitex: Green Gold (Half-White)'},
      {red: 130, green: 143, blue: 133, name: 'Liquitex: Hooker\'s Green Hue Permanent (Half-White)'},
      {red: 144, green: 154, blue: 139, name: 'Liquitex: Hooker\'s Green Deep Hue Permanent (Half-White)'},
      {red: 227, green: 184, blue: 128, name: 'Liquitex: Indian Yellow (Half-White)'},
      {red: 151, green: 145, blue: 148, name: 'Liquitex: Indanthrene Blue (Half-White)'},
      {red: 209, green: 193, blue: 158, name: 'Liquitex: Iridescent Antique Gold (Half-White)'},
      {red: 224, green: 203, blue: 160, name: 'Liquitex: Iridescent Bright Gold (Half-White)'},
      {red: 213, green: 211, blue: 207, name: 'Liquitex: Iridescent Bright Silver (Half-White)'},
      {red: 186, green: 167, blue: 153, name: 'Liquitex: Iridescent Rich Bronze (Half-White)'},
      {red: 196, green: 156, blue: 145, name: 'Liquitex: Iridescent Rich Copper (Half-White)'},
      {red: 210, green: 189, blue: 154, name: 'Liquitex: Iridescent Rich Gold (Half-White)'},
      {red: 209, green: 207, blue: 207, name: 'Liquitex: Iridescent Rich Silver (Half-White)'},
      {red: 236, green: 230, blue: 227, name: 'Liquitex: Iridescent White (Half-White)'},
      {red: 128, green: 128, blue: 128, name: 'Liquitex: Ivory Black (Half-White)'},
      {red: 164, green: 210, blue: 235, name: 'Liquitex: Light Blue Permanent (Half-White)'},
      {red: 180, green: 198, blue: 237, name: 'Liquitex: Light Blue Violet (Half-White)'},
      {red: 159, green: 212, blue: 159, name: 'Liquitex: Light Emerald Green (Half-White)'},
      {red: 136, green: 196, blue: 147, name: 'Liquitex: Light Green Permanent (Half-White)'},
      {red: 244, green: 212, blue: 204, name: 'Liquitex: Light Portrait Pink (Half-White)'},
      {red: 150, green: 150, blue: 150, name: 'Liquitex: Mars Black (Half-White)'},
      {red: 128, green: 157, blue: 193, name: 'Liquitex: Manganese Blue Hue (Half-White)'},
      {red: 214, green: 160, blue: 184, name: 'Liquitex: Medium Magenta (Half-White)'},
      {red: 220, green: 144, blue: 148, name: 'Liquitex; Naphthol Crimson (Half-White)'},
      {red: 228, green: 151, blue: 143, name: 'Liquitex: Naphthol Red Light (Half-White)'},
      {red: 175, green: 175, blue: 175, name: 'Liquitex: Neutral Gray 5 (Half-White)'},
      {red: 148, green: 147, blue: 146, name: 'Liquitex: Payne\'s Gray (Half-White)'},
      {red: 196, green: 138, blue: 142, name: 'Liquitex: Pyrrole Crimson (Half-White)'},
      {red: 193, green: 136, blue: 141, name: 'Liquitex: Quinacridone Red Orange (Half-White)'},
      {red: 218, green: 146, blue: 146, name: 'Liquitex: Quinacridone Red (Half-White)'},
      {red: 239, green: 212, blue: 164, name: 'Liquitex: Naples Yellow Hue (Half-White)'},
      {red: 144, green: 141, blue: 160, name: 'Liquitex: Phthalo Blue (Green Shade) (Half-White)'},
      {red: 142, green: 138, blue: 156, name: 'Liquitex: Phthalo Blue (Red Shade) (Half-White)'},
      {red: 151, green: 149, blue: 151, name: 'Liquitex: Prussian Blue Hue (Half-White)'},
      {red: 145, green: 150, blue: 150, name: 'Liquitex: Phthalo Green (Blue Shade) (Half-White)'},
      {red: 136, green: 145, blue: 143, name: 'Liquitex: Phthalo Green (Yellow Shade) (Half-White)'},
      {red: 154, green: 146, blue: 149, name: 'Liquitex: Prism Violet (Half-White)'},
      {red: 236, green: 162, blue: 145, name: 'Liquitex: Pyrrole Orange (Half-White)'},
      {red: 204, green: 136, blue: 135, name: 'Liquitex: Pyrrole Red (Half-White)'},
      {red: 152, green: 142, blue: 143, name: 'Liquitex: Quinacridone Blue Violet (Half-White)'},
      {red: 157, green: 143, blue: 141, name: 'Liquitex: Quinacridone Burnt Orange (Half-White)'},
      {red: 181, green: 137, blue: 142, name: 'Liquitex: Quinacridone Magenta (Half-White)'},
      {red: 175, green: 152, blue: 136, name: 'Liquitex: Raw Sienna (Half-White)'},
      {red: 193, green: 150, blue: 139, name: 'Liquitex: Red Oxide (Half-White)'},
      {red: 153, green: 155, blue: 150, name: 'Liquitex: Sap Green Permanent (Half-White)'},
      {red: 164, green: 143, blue: 138, name: 'Liquitex: Transparent Burnt Sienna (Half-White)'},
      {red: 149, green: 147, blue: 143, name: 'Liquitex: Transparent Burnt Umber (Half-White)'},
      {red: 175, green: 157, blue: 136, name: 'Liquitex: Transparent Raw Sienna (Half-White)'},
      {red: 162, green: 160, blue: 156, name: 'Liquitex: Transparent Raw Umber (Half-White)'},
      {red: 141, green: 149, blue: 150, name: 'Liquitex: Transparent Viridian Hue (Half-White)'},
      {red: 230, green: 202, blue: 130, name: 'Liquitex: Turner\'s Yellow (Half-White)'},
      {red: 142, green: 141, blue: 146, name: 'Liquitex: Turquoise Deep (Half-White)'},
      {red: 216, green: 205, blue: 189, name: 'Liquitex: Unbleached Titanium (Half-White)'},
      {red: 150, green: 148, blue: 164, name: 'Liquitex: Ultramarine Blue (Green Shade) (Half-White)'},
      {red: 145, green: 143, blue: 158, name: 'Liquitex: Ultramarine Blue (Red Shade) (Half-White)'},
      {red: 154, green: 144, blue: 139, name: 'Liquitex: Van Dyke Red (Half-White)'},
      {red: 170, green: 203, blue: 139, name: 'Liquitex: Vivid Lime Green (Half-White)'},
      {red: 152, green: 156, blue: 153, name: 'Liquitex: Viridian Hue Permanent (Half-White)'},
      {red: 237, green: 209, blue: 128, name: 'Liquitex: Yellow Medium Azo (Half-White)'},
      {red: 241, green: 195, blue: 128, name: 'Liquitex: Yellow Orange Azo (Half-White)'},
      {red: 214, green: 188, blue: 143, name: 'Liquitex: Yellow Oxide (Half-White)'},
      {red: 52, green: 25, blue: 24, name: 'Golden: Alizarin Crimson Historic Hue'},
      {red: 37, green: 27, blue: 34, name: 'Golden: Anthraquinone Blue'},
      {red: 198, green: 139, blue: 6, name: 'Golden: Aureolin Historic Hue'},
      {red: 36, green: 43, blue: 58, name: 'Golden: Azurite Historic Hue'},
